...
window.WorkspaceView = {
  ...
  stagesList: [
    { name: "Acquiring and parsing document...", threshold: 10 },
    { name: "Executing formatting analysis...", threshold: 25 },
    { name: "Analyzing structural outline & section hierarchy...", threshold: 35 },
    { name: "Cross-checking Table of Contents...", threshold: 45 },
    { name: "Analyzing tabular data and cell synchronicity...", threshold: 55 },
    { name: "Evaluating grammar, syntax & technical vocabulary...", threshold: 65 },
    { name: "Extracting domain-specific engineering parameters...", threshold: 75 },
    { name: "Validating fixed engineering template...", threshold: 80 },
    { name: "Detecting semantic propositions & cross-document contradictions...", threshold: 85 },
    { name: "Comparing parameters against local engineering standards...", threshold: 92 },
    { name: "Computing severity scores and ranking critical issues...", threshold: 98 },
